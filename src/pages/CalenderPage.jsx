...
const CalendarPage = () => {
  ...
  const [selectedDate, setSelectedDate] = useState("No Date"); // State to store the selected date
  ...
  return (
    <>
      <div className="bg-white-A700 font-roboto h-[100vh] mx-auto relative w-full">
            ...
            <div className="bg-white-A700 border-gray-100 border-solid border-t flex flex-row gap-5 items-center justify-start p-4 rounded-bl-[16px] rounded-br-[16px] w-[100%] md:w-full">
              ...
              <div className="flex flex-row gap-4 items-start justify-start w-auto">
                <div className="flex flex-col items-center justify-start w-[46%]">
                  <button className="font-sans rounded-lg bg-blue-50 text-blue-500 cursor-pointer font-medium font-roboto leading-[normal] min-w-[73px] rounded-md text-center text-sm p-[9px]">
                    Cancel
                  </button>
                </div>
                <button className="font-sans p-[9px] bg-blue-500 rounded-lg !text-white-A700 cursor-pointer font-medium font-roboto leading-[normal] min-w-[73px] rounded-md text-center text-sm">
                  Save
                </button>
              </div>
            </div>
